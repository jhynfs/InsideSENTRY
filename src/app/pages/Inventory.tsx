...
export function Inventory() {
  ...
  const confirmDelete = async () => {
    ...
    const db = await getDB();
    await db.delete('items', itemToDelete.id);
    await addAuditLog('Delete Item', `Deleted item: ${itemToDelete.equipmentName}`, itemToDelete.id);
    loadItems();
  ...
  return (
    <div className="p-8">
      ...
      <ConfirmDialog
        ...
        title="Delete Item"
        message={`Delete ${itemToDelete?.equipmentName}?`}
